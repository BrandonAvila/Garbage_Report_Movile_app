...
class Animated_screen_loading extends StatefulWidget {
  const Animated_screen_loading ({Key? key}) : super(key: key);

  @override
  State<Animated_screen_loading> createState() => _animated_screen_loadingState();
}

class _animated_screen_loadingState extends State<Animated_screen_loading>
