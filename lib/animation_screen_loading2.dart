...
class Animated_screen_loading2 extends StatefulWidget {
  const Animated_screen_loading2 ({Key? key}) : super(key: key);

  @override
  State<Animated_screen_loading2> createState() => _animated_screen_loading2State();
}

class _animated_screen_loading2State extends State<Animated_screen_loading2>
