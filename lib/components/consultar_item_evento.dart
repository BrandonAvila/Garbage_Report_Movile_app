...
class Consultar_item_evento extends StatelessWidget {
  final Evento evento;

  const Consultar_item_evento(this.evento, {Key? key}) : super(key: key);
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      'Eventos organizados por Pro-Natura'.toString().toUpperCase(),
                                      style: TextStyle(
                                        fontSize: 12,
                                        color: Colors.grey,
                                      ),
