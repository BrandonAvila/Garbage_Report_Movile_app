...
class Consultar_item_denuncia extends StatelessWidget {
  final Denuncia denuncia;

  const Consultar_item_denuncia(this.denuncia, {Key? key}) : super(key: key);
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Text(
                                      denuncia.nombreDenuncia.toString().toUpperCase(),
                                      style: TextStyle(
                                        fontSize: 14,
                                    ...
                                    Text(
                                      denuncia.descripcionDenuncia.toString().toUpperCase(),
                                      style: TextStyle(
                                        fontSize: 12,
                                        color: Colors.grey,
                                      ),
